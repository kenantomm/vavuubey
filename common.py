...
def check_settings_tables():
    sett = [
        ...
        ('serienstream_username', 'Hidden', '', '["Benutzername vom serienstream Account (s.to)", "Username of S.to User Accound"]', '', 'text', ''),
        ('serienstream_password', 'Hidden', '', '["Passwort für serienstream Account (s.to)", "Password for S.to User Accound"]', '', 'text', ''),
